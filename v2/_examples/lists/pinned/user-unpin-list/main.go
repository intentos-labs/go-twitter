...
func main() {
	...
	fmt.Println("Callout to user pin list callout")

	listResponse, err := client.UserUnpinList(context.Background(), *userID, *listID)
	if err != nil {
		log.Panicf(" user pin list error: %v", err)
	}
